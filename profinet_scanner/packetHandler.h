...
#define TIMEOUT8 8000
#define TIMEOUT10 10000
...
extern int sendPacket_RPC(threadData_t* threadData, int deviceNumber);
extern int sendpacket_IM(threadData_t* threadData, int deviceNumber, u_short index, int slotCount);
...
extern char* cutDataFromString(u_char *annotation, int* offset);
